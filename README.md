...
**Универсальный голосовой информационный хаб для мгновенного доступа к данным**

[![Python](https://img.shields.io/badge/Python-3.8+-blue.svg)](https://www.python.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Platform](https://img.shields.io/badge/Platform-Windows%20%7C%20Linux%20%7C%20macOS-green.svg)]()

*Получай погоду, курсы валют, новости и ответы на вопросы одной командой!*
...
### 🔍 Умный поиск
- 💡 Краткая сводка: "Погода в Москве" → мгновенный ответ
- 🧮 Калькулятор: "2+2*3" → результат
- 🌐 Веб-поиск: Ссылки на DuckDuckGo и Google
...
- 🔄 **v0.7.0**: Полное голосовое управление
- 🚀 **v0.8.0**: Дополнительные виджеты (пробки, кино, спорт)
